...
waypoint = "Waypoint {} at Latitude {} and Longitude {}".format(
    catacombs.name, catacombs.lat, catacombs.lon
)
print(waypoint)
...
geocache = "Waypoint {} \nat Latitude {} and Longitude {} \nwith a difficulty of {} and size {}".format(
    newberry_views.name,
    newberry_views.lat,
    newberry_views.lon,
    newberry_views.difficulty,
    newberry_views.size,
)
print(geocache)
